...
const Bug = () => {
  return (
    <div className='w-full mt-5'>
      ...
      <Link to={'/reportbug'} className="bg-gradient-to-r from-slate-600 to-slate-900 px-2 py-3 rounded-md text-white md:p-5 font-bold text-[14px] md:text-xl relative text-white 
